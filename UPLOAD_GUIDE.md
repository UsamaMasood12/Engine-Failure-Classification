...
1. **Hugging Face Dataset Repo** (`UsamaMasood12ak/engine-maintenance-dataset`)
2. **Hugging Face Model Repo** (`UsamaMasood12ak/engine-maintenance-model`)
3. **Hugging Face Space** (`UsamaMasood12ak/engine-maintenance-space`)
4. **GitHub Repository** (`UsamaMasood12/engine-predictive-maintenance`)

---

## 1. Hugging Face Dataset Repo

**Repo ID**: `UsamaMasood12ak/engine-maintenance-dataset`  
...
**Repo ID**: `UsamaMasood12ak/engine-maintenance-model`  
...
**Repo ID**: `UsamaMasood12ak/engine-maintenance-space`  
...
**Repo URL**: `https://github.com/UsamaMasood12/engine-predictive-maintenance`  
