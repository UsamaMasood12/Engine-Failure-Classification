...
```bash
cd /Users/UsamaMasood12/Desktop/mlops
...
git remote add origin https://github.com/UsamaMasood12/engine-predictive-maintenance.git
...
**Repo**: `UsamaMasood12ak/engine-maintenance-dataset`
...
- Go to https://huggingface.co/datasets/UsamaMasood12ak/engine-maintenance-dataset
...
**Repo**: `UsamaMasood12ak/engine-maintenance-model`
...
**Option 2: Manual upload via HF Hub**
- Go to https://huggingface.co/UsamaMasood12ak/engine-maintenance-model
...
**Repo**: `UsamaMasood12ak/engine-maintenance-space`
...
**Option 2: Manual upload via HF Hub**
- Go to https://huggingface.co/spaces/UsamaMasood12ak/engine-maintenance-space
...
### ✅ Step 5: Verify
- [ ] Check GitHub repo: https://github.com/UsamaMasood12/engine-predictive-maintenance
- [ ] Check HF Dataset: https://huggingface.co/datasets/UsamaMasood12ak/engine-maintenance-dataset
- [ ] Check HF Model: https://huggingface.co/UsamaMasood12ak/engine-maintenance-model
- [ ] Check HF Space: https://huggingface.co/spaces/UsamaMasood12ak/engine-maintenance-space
