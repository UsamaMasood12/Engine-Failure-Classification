...
Edit `/Users/UsamaMasood12/Desktop/mlops/src/config.py` and replace the placeholder values:
...
**Example** (HF username: `UsamaMasood12ak`, GitHub username: `UsamaMasood12`):
```python
HF_DATASET_REPO = os.getenv(
    "HF_DATASET_REPO", "UsamaMasood12ak/engine-maintenance-dataset"
)
HF_MODEL_REPO = os.getenv("HF_MODEL_REPO", "UsamaMasood12ak/engine-maintenance-model")
HF_SPACE_REPO = os.getenv("HF_SPACE_REPO", "UsamaMasood12ak/engine-maintenance-space")
```
...
2. **`HF_DATASET_REPO`**
   ...
   - Example: `UsamaMasood12ak/engine-maintenance-dataset`

3. **`HF_MODEL_REPO`**
   - Value: Your Hugging Face model repo ID
   - Example: `UsamaMasood12ak/engine-maintenance-model`

4. **`HF_SPACE_REPO`**
   - Value: Your Hugging Face Space repo ID
   - Example: `UsamaMasood12ak/engine-maintenance-space`
...
Edit `/Users/UsamaMasood12/Desktop/mlops/README.md` and add your GitHub repository link:
