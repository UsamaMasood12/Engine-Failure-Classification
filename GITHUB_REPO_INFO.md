...
- **GitHub Username**: `UsamaMasood12`
- **Repository Name**: `engine-predictive-maintenance` (or your chosen name)
- **Full Repository URL**: `https://github.com/UsamaMasood12/engine-predictive-maintenance`
...
- **Repository URL**: https://github.com/UsamaMasood12/engine-predictive-maintenance
- **GitHub Actions Workflow**: https://github.com/UsamaMasood12/engine-predictive-maintenance/actions
...
3. **Add GitHub Secrets:**
   - Go to: https://github.com/UsamaMasood12/engine-predictive-maintenance/settings/secrets/actions
...
4. **Verify GitHub Actions:**
   - After pushing, go to: https://github.com/UsamaMasood12/engine-predictive-maintenance/actions
   - You should see the "Predictive Maintenance Pipeline" workflow running
   - All 4 jobs should complete successfully

## Important Notes

- **GitHub username** (`UsamaMasood12`) is used for the repository URL
